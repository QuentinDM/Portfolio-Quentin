        ...
        <div className="projet-images">
            ...
            <div className="projet-text">
                ...
                <div className="projet-icon-content">
                    {slides[currentTextIndex].text.icon}
                </div>
            </div>
